...
-- Oracle SISUD.CSEP_INFORMES_VIEW (informes de supervision; dump docs/input_examples)
CREATE TABLE IF NOT EXISTS STG_ORA_CSEP_INFORMES (
    IDACTIVIDAD                   BIGINT,
    TXMES                         VARCHAR,
    TXNUMEXP                      VARCHAR,
    TXCUC                         VARCHAR,
    TXESTADO                      VARCHAR,
    IDADMINISTRADO                VARCHAR,
    TXADMINISTRADO                VARCHAR,
    IDSUBUNIDAD                   VARCHAR,
    IDUF_SIG                      VARCHAR,
    TXSUBUNIDAD                   VARCHAR,
    TXCOORDINACION                VARCHAR,
    TXTIPSUP                      VARCHAR,
    TXFUENTE                      VARCHAR,
    TXOTRAFUENTE                  VARCHAR,
    TXACCION                      VARCHAR,
    FEINICIO                      TIMESTAMP,
    FEFIN                         TIMESTAMP,
    TXMUESTREO                    VARCHAR,
    TXNVL_CMPLJ                   VARCHAR,
    TXNVL_CMPLJ_1                 VARCHAR,
    TXNVL_CMPLJ_2                 VARCHAR,
    TXNVL_CMPLJ_3                 VARCHAR,
    TXNOMBRE_RESP_COMISION        VARCHAR,
    TXNOMBRE_RESP_MONITOREO       VARCHAR,
    TXNOMBRE_ANAL_LEGAL           VARCHAR,
    TXNOMBRE_JEFE_ACTIVIDAD       VARCHAR,
    FEINI_ELAB_INF_ACT            TIMESTAMP,
    TXNIVELES_REVISION            VARCHAR,
    IDEJECFILE_PRY_INF_MIN        BIGINT,
    IDEJECFILE_PRY_INF_MAX        BIGINT,
    IDEJECFILE_INF_MAX            BIGINT,
    IDTIPOEJEFILE_PRY             VARCHAR,
    IDGRUPO_REVISION              BIGINT,
    IDEJECFILE_DOC_PREVIO_MAX     BIGINT,
    FEPRY_REG_INICIAL             TIMESTAMP,
    TXPRY_NIVEL                   VARCHAR,
    TXPRY_ESTADO                  VARCHAR,
    FEPRY_REG                     TIMESTAMP,
    FEPRY_MOD_ESTADO_ESPERADO     TIMESTAMP,
    FEPRY_MOD_ESTADO_REAL         TIMESTAMP,
    TXINFORME                     VARCHAR,
    FEINFORME_ESPERADO            TIMESTAMP,
    FEINFORME                     TIMESTAMP,
    FEREG_INFORME                 TIMESTAMP,
    TXRECOMENDACION               VARCHAR,
    TXSUBSECTOR_UND               VARCHAR,
    TX_DOC_DERIVACION             VARCHAR,
    TX_NUM_DOC_DERIVACION         VARCHAR,
    FE_APROB_DOC_DERIVACION       TIMESTAMP,
    FE_DERIV_DOC_DERIVACION       TIMESTAMP,
    TXAREADESTINO_MEMO_DERIVACION VARCHAR,
    FEINI_ELAB_INF                TIMESTAMP,
    TX_DOCUMENTO_PREVIO           VARCHAR,
    TX_NUMERO_DOCUMENTO_PREVIO    VARCHAR,
    FE_DOCUMENTO_PREVIO           TIMESTAMP,
    FE_REGISTRO_DOCUMENTO_PREVIO  TIMESTAMP,
    TX_OTRO_DOCUMENTO_PREVIO      VARCHAR
);
